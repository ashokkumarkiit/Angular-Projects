  ...
  fetchPlaces() {
    this.placesService
      ...
      .subscribe((data: Place[]) => {
        ...
        // Write a for loop to read places in order to 
        // populate list_of_places with every restaurant name and review count

        this.places.map(place => {
          list_of_places.push({"name": place.name, "review_count": place.review_count})
        });
